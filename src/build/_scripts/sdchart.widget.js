...
var WL_HOST = 'https://mandgtools.kurtosysweb.com';

var WL_CSSFILES = [
//	'//cloud.webtype.com/css/a48c2f3e-f82c-4747-9c4a-630b03dcbcb8.css',
	WL_HOST+"/_styles/sdchart.styles.css"
];
...
window.LoadTranslations = function() {
	setTimeout(function() {
		...
		var baseURL = 'https://mandgtools.kurtosysweb.com';
		var clientName = 'sMANDGTOOLSLive';
		var dataSource = '6641a6c5-740b-4903-8b63-d2e110f73b02';
...
window.LoadAngular = function() {
	setTimeout(function() {
		...
		angularTag.src = 'https://mandgtools.kurtosysweb.com/_scripts/angular-xdomain-fixed.js'; // for devel-01, uat, prod

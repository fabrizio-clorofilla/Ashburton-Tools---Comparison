/* Built with Makefile.bat. If possible, do not change this file directly. */ 
/**
 * @namespace Utils
 *
 * @description
...
function SDCHART_STATIC_CONFIG() {
  ...
  this.SITE_URL = 'https://mandgtools.kurtosysweb.com';
  this.ServiceURL = 'https://mandgtools.kurtosysweb.com';
  this.OptionsURL = 'https://mandgtools.kurtosysweb.com';
  this.ClientName = 'sMANDGTOOLSLive';
  this.Company = 'MANDGTOOLS';//'MANDGWEBTOOLS'
  ...
  this.DataSource = {
    ...
    fundsList: 'ce91f042-0af0-4ce2-bb71-63c911af98b3',
    translations: '6641a6c5-740b-4903-8b63-d2e110f73b02',
    // OPTIONS PAGE DATASOURCES
    optionsClientType: 'aae6c8de-9365-4d26-8c6f-dec7755f3466',
    optionsCountry: 'a88abad1-57e3-4ff7-bf58-abe71be6667f',
    optionsLanguage: '1406fa91-adaf-4c6b-91b0-d5cd3efecd85',
    optionsFund: 'ea9d1aa0-df68-4b76-b592-dc1ca43de364'
  };
  ...
  this.Template = {
    Main: '<div ng-include src="\'https://mandgtools.kurtosysweb.com/sdchart.static.aspx\'"></div>',
    Tabs: {
      YtoY: 'https://mandgtools.kurtosysweb.com/sdchart.static.ytoy-tab.aspx',
      CalYr: 'https://mandgtools.kurtosysweb.com/sdchart.static.calyr-tab.aspx',
      Cumul: '',
      Risk: ''
    }
  };
...
function SDCHART_DYNAMIC_CONFIG() {
  ...
  this.Template = {
    Main: '<div ng-include src="\'https://mandgtools.kurtosysweb.com/sdchart.dynamic.aspx\'"></div>',
    Tabs: {
      YtoY: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.ytoy-tab.aspx',
      CalYr: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.calyr-tab.aspx',
      Cumul: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.cum-tab.aspx',
      Risk: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.risk-tab.aspx'
    },
    DatePicker: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.datepicker.aspx'
  };
      ...
      area: {
        ...
        /*,
          fillColor: {
              ...
              pattern: 'https://mandgtools.kurtosysweb.com/_images/mandg_dark_blue_tile.gif',
              width: 5,
              height: 5
          }
        */
...
function SDCHART_ENTRYCHARGE_CONFIG() {
  ...
  this.Template = {
    Main: '<div ng-include src="\'https://mandgtools.kurtosysweb.com/sdchart.entrycharge.aspx\'"></div>'
  };
...
angular.module('SDCHART').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('https://mandgtools.kurtosysweb.com/sdchart.dynamic.risk-tab.aspx',
  ...
  $templateCache.put('https://mandgtools.kurtosysweb.com/sdchart.dynamic.typeahead-match.aspx',
    "<a tabindex=-1 bind-html-unsafe=\"match.label | typeaheadHighlight:query\"></a>"
  );


  $templateCache.put('https://mandgtools.kurtosysweb.com/sdchart.dynamic.typeahead.aspx',
  ...
  $templateCache.put('https://mandgtools.kurtosysweb.com/sdchart.static.calyr-tab.aspx',
  ...
  $templateCache.put('https://mandgtools.kurtosysweb.com/sdchart.static.ytoy-tab.aspx',
                        ...
                        if (value != "" && value != oldValue) {
                            ...
                            if (scope.DataService.isDynamic()) {
                                ...
                                scope.chart.serieses[0].fillColor = {
                                    pattern: 'https://mandgtools.kurtosysweb.com/_images/mandg_dark_blue_tile.gif',
                                    // pattern: 'https://mandgtools.kurtosysweb.com/_images/vanilla_dark_blue_tile.png',
                                    width: 5,
                                    height: 5
                                };
...
.directive('typeaheadPopup', function() {
    return {
        ...
        replace: true,
        templateUrl: 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.typeahead.aspx',
...
.directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse',
    function($http, $templateCache, $compile, $parse) {
        return {
            ...
            link: function(scope, element, attrs) {
                var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || 'https://mandgtools.kurtosysweb.com/sdchart.dynamic.typeahead-match.aspx';
                $http.get(tplUrl, {
                    cache: $templateCache
    ...
    function($scope, $rootScope, OptionsPageService) {
        ...
        $scope.stage = function(version) {
            if ($scope.selections.fund != "") {
                setTimeout(function() {
                    if (version == 'static') {
                        window.open($rootScope.config.SITE_URL + '/options/sdchart.static.staging.aspx?website=' + $scope.selections.clienttype + '&country=' + $scope.selections.country + '&language=' + $scope.selections.language + '&isin=' + $scope.selections.fund + '&benchmark=' + $scope.funds.list[$scope.selections.fund].BenchmarkId + '&sector=' + $scope.funds.list[$scope.selections.fund].SectorId + '&category=' + $scope.funds.list[$scope.selections.fund].CategoryId + '&hidetab=cum,risk&perftype=' + $scope.selections.static.perftype);
                    }
                    if (version == 'dynamic') {
                        var hideelement = {
                            array: [],
                        ...
                        window.open($rootScope.config.SITE_URL + '/options/sdchart.dynamic.staging.aspx?website=' + $scope.selections.clienttype + '&country=' + $scope.selections.country + '&language=' + $scope.selections.language + '&isin=' + $scope.selections.fund + '&benchmark=' + $scope.funds.list[$scope.selections.fund].BenchmarkId + '&sector=' + $scope.funds.list[$scope.selections.fund].SectorId + '&category=' + $scope.funds.list[$scope.selections.fund].CategoryId + '&hidetab=' + hidetab.list + '&perftype=' + $scope.selections.dynamic.perftype + '&hideelement=' + hideelement.list);
                    }
                    if (version == 'entryCharge') {
                        window.open($rootScope.config.SITE_URL + '/options/sdchart.entrycharge.staging.aspx?website=' + $scope.selections.clienttype + '&country=' + $scope.selections.country + '&language=' + $scope.selections.language + '&isin=' + $scope.selections.fund);
                    }
                });
            }
